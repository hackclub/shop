...
export default () => (
  <Base align="center" color="black" p={[4, 5]}>
    <Text f={3}>
      ...
      <Link href="https://merelinguist.me/">@merelinguist</Link>,{' '}
      <Link href="https://zane.sh">@zanedb</Link>, and{' '}
      <Link href="https://hackclub.com">Hack Club</Link>
    </Text>
    <Wrapper href="https://github.com/hackclub/shop" mt={3}>
      <svg
